        ...
        {!connected ? (
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Use Petra Wallet to connect and start sending digital gifts on Aptos
            </p>
          </div>
        ) : (
          <div className="space-y-8">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-semibold text-gray-900">Your Gifts</h2>
            </div>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {/* Gift cards will be dynamically loaded here */}
            </div>
